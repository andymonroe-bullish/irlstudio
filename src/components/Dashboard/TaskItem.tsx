...
import { Check, Circle, Clock, Trash2, User, ChevronDown } from "lucide-react";
      ...
      {(provided, snapshot) => (
        <div
          ...
          className={cn(
            ...
            "hover:bg-secondary/30 cursor-grab active:cursor-grabbing",
            snapshot.isDragging && "shadow-lg bg-card border border-primary/20"
          )}
        >
          {/* Status Dropdown */}
          <DropdownMenu>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="flex items-center gap-1 px-2 py-1 rounded-md hover:bg-secondary transition-colors">
                {task.assignee ? (
